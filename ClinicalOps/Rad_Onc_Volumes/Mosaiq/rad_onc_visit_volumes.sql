...
/****
Inigo, using the visit system

adaptations for rad-onc (like and act-desc)	
	******/
SELECT distinct
      [pat_mrn] as MRN
      ...
      ,Quotename(actv_desc,'"') as actv_desc
      ,[sch_Status_Prim]
      ,[FY]
	 ,adm.pat_postal
  ...
  where FY>=2021
   and prov_specialty_type_mq like 'Rad-Onc%'
